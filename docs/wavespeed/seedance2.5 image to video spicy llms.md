...
SUBMIT_RESPONSE=$(curl --silent --show-error --fail \
  --request POST \
  --url https://api.wavespeed.ai/api/v3/bytedance/seedance-2.5/image-to-video-spicy \
...
- [Model Playground](https://wavespeed.ai/models/bytedance/seedance-2.5/image-to-video-spicy)
- [API Documentation](https://wavespeed.ai/docs/docs-api/bytedance/seedance-2.5/image-to-video-spicy)
