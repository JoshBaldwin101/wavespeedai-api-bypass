...
- **Endpoint**: `https://api.wavespeed.ai/api/v3/bytedance/seedance-2.0-mini/video-edit`
- **Polling/result URL**: returned in `urls.get` (fallback: `https://api.wavespeed.ai/api/v3/predictions/${PREDICTION_ID}/result`)
- **Model ID**: `bytedance/seedance-2.0-mini/video-edit`
...
SUBMIT_RESPONSE=$(curl --silent --show-error --fail \
  --request POST \
  --url https://api.wavespeed.ai/api/v3/bytedance/seedance-2.0-mini/video-edit \
...
- [Model Playground](https://wavespeed.ai/models/bytedance/seedance-2.0-mini/video-edit)
- [API Documentation](https://wavespeed.ai/docs/docs-api/bytedance/seedance-2.0-mini/video-edit)
