...
- **Endpoint**: `https://api.wavespeed.ai/api/v3/bytedance/seedance-2.5/text-to-video-turbo`
- **Polling/result URL**: returned in `urls.get` (fallback: `https://api.wavespeed.ai/api/v3/predictions/${PREDICTION_ID}/result`)
- **Model ID**: `bytedance/seedance-2.5/text-to-video-turbo`
...
SUBMIT_RESPONSE=$(curl --silent --show-error --fail \
  --request POST \
  --url https://api.wavespeed.ai/api/v3/bytedance/seedance-2.5/text-to-video-turbo \
...
- [Model Playground](https://wavespeed.ai/models/bytedance/seedance-2.5/text-to-video-turbo)
- [API Documentation](https://wavespeed.ai/docs/docs-api/bytedance/seedance-2.5/text-to-video-turbo)
