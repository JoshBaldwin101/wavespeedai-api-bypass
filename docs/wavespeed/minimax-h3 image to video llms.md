...
- **Endpoint**: `https://api.wavespeed.ai/api/v3/wavespeed-ai/minimax-h3/image-to-video`
- **Polling/result URL**: returned in `urls.get` (fallback: `https://api.wavespeed.ai/api/v3/predictions/${PREDICTION_ID}/result`)
- **Model ID**: `wavespeed-ai/minimax-h3/image-to-video`
...
- [Model Playground](https://wavespeed.ai/models/wavespeed-ai/minimax-h3/image-to-video)
- [API Documentation](https://wavespeed.ai/docs/docs-api/wavespeed-ai/minimax-h3/image-to-video)
