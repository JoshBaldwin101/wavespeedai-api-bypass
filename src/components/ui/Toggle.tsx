...
export const Toggle = ({ checked, onChange, label, description, id }: ToggleProps) => (
  <label
    className="flex cursor-pointer items-center justify-between gap-3 rounded-lg border border-slate-800 bg-slate-900/60 px-3 py-2.5 sm:items-start sm:gap-4 sm:px-4 sm:py-3"
    htmlFor={id}
  >
